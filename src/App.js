...
class App extends Component {
  ...
  render() {
    const {isPlaying, activeTabId, time, activeImgUrl, score} = this.state
    ...
    return (
      <div className="bg-container">
        <nav className="nav-container">
          ...
          />
          <ul className="score-show-container">
            <li className="score-count">
              <p>
                Score: <span className="score-name">{score}</span>
              </p>
            </li>
            <li className="score-show-container">
              <img
        ...
        <div className="content-container">
          {isPlaying && (
            <div className="view-image-container">
              <img src={activeImgUrl} alt="match" className="view-image" />
                ...
                {tabsList.map(eachItem => (
                  <li key={eachItem.tabId}>
                    <button
                      type="button"
                      className={`tab-item ${
                        activeTabId === eachItem.tabId ? 'highlight-text' : ''
                      }`}
                ...
                {filteredList.map(eachImage => (
                  <li key={eachImage.id}>
                    <button
                      ...
                      onClick={() => this.imageClick(eachImage.imageUrl)}
                    >
                      <img
